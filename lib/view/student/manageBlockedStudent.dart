...
class ManageBlockedStudent extends StatefulWidget {
  const ManageBlockedStudent({super.key});

  @override
  State<ManageBlockedStudent> createState() => _ManageBlockedStudentState();
}

class _ManageBlockedStudentState extends State<ManageBlockedStudent> {
  int crocesscount = 0;
      ...
      _service.sessionGroup(sessionRequest).then((value) {
        ...
        if (value.error == false) {
          setState(() {
            ...
            _service.manageStudentBlocked(simpleRequest).then((value) {
  ...
  Widget build(BuildContext context) {
    ...
    } else if (permissions.contains('view_blocked_student')) {
      return SafeArea(
        child: Scaffold(
          appBar: AppBar(
                                                          ...
                                                          if (permissions.contains(
                                                            ...
                                                            IconButton(
                                                              ...
                                                              onPressed: () {
                                                                showMyDialog(
                                                                    "Unblock?",
                                                                    "Alert! Are you sure you want to Unblock the." +
                          ...
                          Expanded(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                ...
                                if (title == 'Unblock?') {
                                  callApiToUnBlockStudent(id, session);
                                } else {
                            ...
                            child: GestureDetector(
                              onTap: () {
                                setState(() {
                                  ...
                                  _service
                                      .manageStudentBlocked(simpleRequest)
                                      .then((value) {
                                    studentResponse = value;
  ...
  callApiToUnBlockStudent(String id, String session) {
    setState(() {
      isLoading = true;
    });
    ...
    blockStudentRequest.type = 'unblock';
    blockStudentRequest.session = newYear;

    _service.unblockStudent(blockStudentRequest).then((value) {
      simpleResponse = value;

      setState(() {
        if (simpleResponse.error == false) {
          isLoading = false;
          AppUtil.showToast(simpleResponse.msg.toString(), "s");
          Navigator.pushNamed(
            context,
            '/BlockedStudent',
            arguments: {
