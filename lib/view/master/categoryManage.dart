...
class _ManageCategoryState extends State<ManageCategory> {
  ...
  void initState() {
    ...
    SharedPreferences.getInstance().then((SharedPreferences sp) {
      ...
      _service.category(simpleRequest).then((value) {
  ...
  Widget build(BuildContext context) {
    ...
    } else if (permissions.contains('manage_category')) {
      return SafeArea(
        child: Scaffold(
          appBar: AppBar(
  ...
  callApiToDeleteOrganisation(String id) {
    ...
    _service.deleteCategory(deleteRequest).then((value) {
