...
class _EditCategoryState extends State<EditCategory> {
  ...
  void initializeDepartmentData(BuildContext context) {
    ...
    if (arguments['id'] != null) {
      ...
      Navigator.pushReplacementNamed(context, '/ManageCategory');
    }
  }

  void _submitForm() {
    if (nameController.text.isEmpty) {
      AppUtil.showToast("Please Enter Category Name", "e");
    } else {
      SharedPreferences.getInstance().then((SharedPreferences sp) {
        ...
        service.editCategory(editDegreeRequest).then((value) async {
  ...
  Widget build(BuildContext context) {
    ...
    } else if (permissions.contains('edit_category')) {
      return SafeArea(
        child: Scaffold(
          key: _scaffoldKey,
          appBar: AppBar(
