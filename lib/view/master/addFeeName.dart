...
class AddFeeName extends StatefulWidget {
  const AddFeeName({super.key});

  @override
  State<AddFeeName> createState() => _AddFeeNameState();
}

class _AddFeeNameState extends State<AddFeeName> {
  int crocesscount = 0;
  ...
  Widget build(BuildContext context) {
    ...
    } else if (permissions.contains('add_fee_name')) {
      return SafeArea(
        child: Scaffold(
          key: _scaffoldKey,
          appBar: AppBar(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        child: SizedBox(
                          child: Padding(
                              padding: const EdgeInsets.all(8.0),
                              child: permissions.contains('add_fee_name')
                                  ? Column(
                                      children: [
                                        GridView.count(
