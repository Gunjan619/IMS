...
class AddReligion extends StatefulWidget {
  const AddReligion({super.key});

  @override
  State<AddReligion> createState() => _AddReligionState();
}

class _AddReligionState extends State<AddReligion> {
  int crocesscount = 0;
  ...
  Widget build(BuildContext context) {
    ...
    } else if (permissions.contains('add_religion')) {
      return SafeArea(
        child: Scaffold(
          key: _scaffoldKey,
          appBar: AppBar(
            ...
            leading: IconButton(
                ...
                onPressed: () {
                  Navigator.pushReplacementNamed(context, '/ManageReligion');
                }),
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        child: SizedBox(
                          child: Padding(
                              padding: const EdgeInsets.all(8.0),
                              child: permissions.contains('add_religion')
                                  ? Column(
                                      children: [
                                        GridView.count(
