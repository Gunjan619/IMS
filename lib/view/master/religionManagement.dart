...
class ManageReligion extends StatefulWidget {
  const ManageReligion({super.key});

  @override
  State<ManageReligion> createState() => _ManageReligionState();
}

class _ManageReligionState extends State<ManageReligion> {
  int crocesscount = 0;
  ...
  void initState() {
    ...
    SharedPreferences.getInstance().then((SharedPreferences sp) {
      ...
      _service.religion(simpleRequest).then((value) {
  ...
  Widget build(BuildContext context) {
    ...
    } else if (permissions.contains('manage_religion')) {
      return SafeArea(
        child: Scaffold(
          appBar: AppBar(
            backgroundColor: Theme.of(context).primaryColor,
            actions: [
              if (permissions.contains('add_religion'))
                IconButton(
                  onPressed: (() {
                    Navigator.pushReplacementNamed(context, '/AddReligion');
                  }),
  ...
  callApiToDeleteOrganisation(String id) {
    ...
    _service.deleteReligion(deleteRequest).then((value) {
