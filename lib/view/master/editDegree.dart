...
class _EditDegreeState extends State<EditDegree> {
  ...
  void _submitForm() {
    if (nameController.text.isEmpty) {
      AppUtil.showToast("Please Enter Degree Name", "e");
    } else {
      SharedPreferences.getInstance().then((SharedPreferences sp) {
        ...
        service.editDegree(editDegreeRequest).then((value) async {
  ...
  Widget build(BuildContext context) {
    ...
    } else if (permissions.contains('edit_degree')) {
      return SafeArea(
        child: Scaffold(
          key: _scaffoldKey,
          appBar: AppBar(
