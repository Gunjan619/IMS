...
class ManageYear extends StatefulWidget {
  const ManageYear({super.key});

  @override
  State<ManageYear> createState() => _ManageYearState();
}

class _ManageYearState extends State<ManageYear> {
  int crocesscount = 0;
  ...
  void initState() {
    ...
    SharedPreferences.getInstance().then((SharedPreferences sp) {
      ...
      _service.yearManage(simpleRequest).then((value) {
        yearResponse = value;
  ...
  Widget build(BuildContext context) {
    ...
    } else if (permissions.contains('manage_year')) {
      return SafeArea(
        child: Scaffold(
          appBar: AppBar(
            backgroundColor: Theme.of(context).primaryColor,
            actions: [
              if (permissions.contains('add_year'))
                IconButton(
                  onPressed: (() {
                    Navigator.pushReplacementNamed(context, '/AddYear');
                  }),
                  tooltip: "Add Year",
                  icon: const Icon(
                    ...
                    child: TextField(
                        ...
                        onChanged: (value) {
                          setState(() {
                            ...
                            yearFiltered = yearList
                                .where((yearList) =>
                                    yearList.courseName.toLowerCase().contains(
                                                                    ...
                                                                    Navigator
                                                                      ...
                                                                      arguments: {
                                                                        'id': yearFiltered[index]
                                                                            .id
                                                                            .toString(),
                                                                        'subCourse': yearFiltered[index]
                                                                            .subCourse
                                                                            .toString(),
                                                                        'courseName': yearFiltered[index]
                                                                            .courseName
                                                                            .toString(),
                                                                        'course': yearFiltered[index]
                                                                            .course
                                                                            .toString(),
                                                                      },
                                                                    );
  ...
  callApiToDeleteOrganisation(String id) {
    ...
    _service.deleteYear(deleteRequest).then((value) {
