...
class ManageFeeName extends StatefulWidget {
  const ManageFeeName({super.key});

  @override
  State<ManageFeeName> createState() => _ManageFeeNameState();
}

class _ManageFeeNameState extends State<ManageFeeName> {
  int crocesscount = 0;
  ...
  void initState() {
    ...
    SharedPreferences.getInstance().then((SharedPreferences sp) {
      ...
      _service.manageFeeName(simpleRequest).then((value) {
  ...
  Widget build(BuildContext context) {
    ...
    } else if (permissions.contains('manage_fee_name')) {
      return SafeArea(
        child: Scaffold(
          appBar: AppBar(
            backgroundColor: Theme.of(context).primaryColor,
            actions: [
              if (permissions.contains('add_fee_name'))
                IconButton(
                  onPressed: (() {
                    Navigator.pushReplacementNamed(context, '/AddFeeName');
                  }),
                  tooltip: "Add Fee Name",
                  icon: const Icon(
                    ...
                    child: TextField(
                        ...
                        onChanged: (value) {
                          setState(() {
                            ...
                            degreeFiltered = degreeList
                                .where((degreeList) => degreeList.name
                                    .toLowerCase()
                                                                ...
                                                                child:
                                                                  ...
                                                                  onPressed:
                                                                    ...
                                                                    Navigator
                                                                      ...
                                                                      '/EditFeeName',
                                                                      arguments: {
                                                                        'id': degreeFiltered[index]
                                                                            .id
                                                                            .toString(),
                                                                        'name': degreeFiltered[index]
                                                                            .name
                                                                            .toString(),
                                                                      },
                                                                    );
  ...
  callApiToDeleteOrganisation(String id) {
    ...
    _service.deleteFeeName(deleteRequest).then((value) {
