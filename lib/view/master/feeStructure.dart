...
class _FeeStructureState extends State<FeeStructure> {
  ...
  void initState() {
    ...
    SharedPreferences.getInstance().then((SharedPreferences sp) {
      ...
      _service.feeStructure(simpleRequest).then((value) {
        feeStructureResponse = value;

        if (value.error == false) {
          setState(() {
            structureList = feeStructureResponse.data!;
            structureFiltered = structureList;
            isLoading = false;
          });
        } else {
          setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    } else if (permissions.contains('manage_fee_structure')) {
      return SafeArea(
        child: Scaffold(
          appBar: AppBar(
            backgroundColor: Theme.of(context).primaryColor,
            actions: [
              if (permissions.contains('add_fee_structure'))
                IconButton(
                  onPressed: (() {
                    Navigator.pushReplacementNamed(context, '/AddStructure');
                  }),
              ...
              if (searching == false)
                IconButton(
                    icon: const Icon(
                      Icons.search,
                      color: Colors.white,
                      semanticLabel: 'Search Structure',
                    ),
                    onPressed: () {
                      setState(() {
                        searching = true;
                    ...
                    child: TextField(
                        ...
                        onChanged: (value) {
                          setState(() {
                            ...
                            structureFiltered = structureList
                                .where((structureList) =>
                                    structureList.sessionName
                                        .toLowerCase()
                                        .contains(
                                            _searchResult.toLowerCase()) ||
                                    structureList.courseName
                                        .toLowerCase()
                                        .contains(
                                            _searchResult.toLowerCase()) ||
                                    structureList.subCourseName
                                        .toLowerCase()
                                        .contains(
                                            _searchResult.toLowerCase()) ||
                                    structureList.feeName
                                        .toLowerCase()
                                        .contains(
                                            _searchResult.toLowerCase()) ||
                                    structureList.amount
                                        .toLowerCase()
                    ...
                    child: SizedBox(
                      child: Padding(
                        ...
                        child: isLoading
                            ...
                            : structureFiltered.isNotEmpty
                                ? Container(
                                    padding: EdgeInsets.all(5.0),
                                    child: DynamicHeightGridView(
                                      itemCount: structureFiltered.length,
                                      builder: (ctx, index) {
                                        return Card(
                                            color: Colors.white,
                                                                ...
                                                                child:
                                                                  ...
                                                                  onPressed:
                                                                    ...
                                                                    Navigator
                                                                      ...
                                                                      '/EditStructure',
                                                                      arguments: {
                                                                        'id': structureFiltered[index]
                                                                            .id
                                                                            .toString(),
                                                                        'session': structureFiltered[index]
                                                                            .session
                                                                            .toString(),
                                                                        'sessionName': structureFiltered[index]
                                                                            .sessionName
                                                                            .toString(),
                                                                        'course': structureFiltered[index]
                                                                            .course
                                                                            .toString(),
                                                                        'courseName': structureFiltered[index]
                                                                            .courseName
                                                                            .toString(),
                                                                        'courseYear': structureFiltered[index]
                                                                            .courseYear
                                                                            .toString(),
                                                                        'subCourse': structureFiltered[index]
                                                                            .subCourse
                                                                            .toString(),
                                                                        'subCourseName': structureFiltered[index]
                                                                            .subCourseName
                                                                            .toString(),
                                                                        'feeId': structureFiltered[index]
                                                                            .feeId
                                                                            .toString(),
                                                                        'feeName': structureFiltered[index]
                                                                            .feeName
                                                                            .toString(),
                                                                        'amount': structureFiltered[index]
                                                                            .amount
                                                                            .toString(),
                                                                      },
                                                                    );
