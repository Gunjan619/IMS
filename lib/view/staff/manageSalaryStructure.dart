...
class ManageSalaryStructure extends StatefulWidget {
  const ManageSalaryStructure({super.key});

  @override
  State<ManageSalaryStructure> createState() => _ManageSalaryStructureState();
}

class _ManageSalaryStructureState extends State<ManageSalaryStructure> {
  int crocesscount = 0;
  ...
  SalaryStructureResponse feeStructureResponse = SalaryStructureResponse();
  ...
  void initState() {
    ...
    SharedPreferences.getInstance().then((SharedPreferences sp) {
      ...
      _service.manageStructure(simpleRequest).then((value) {
  ...
  Widget build(BuildContext context) {
    ...
    } else if (permissions.contains('manage_structure')) {
      return SafeArea(
        child: Scaffold(
          appBar: AppBar(
              ...
              if (searching == false)
                IconButton(
                    icon: const Icon(
                      Icons.search,
                      color: Colors.white,
                      semanticLabel: 'Search Salary Structure',
                    ),
                    onPressed: () {
                      setState(() {
                        searching = true;
                ...
                ? Container(
                    ...
                    child: TextField(
                        ...
                        decoration: new InputDecoration(
                          hintText: 'Search Salary Structure',
                        ...
                        onChanged: (value) {
                          setState(() {
                            ...
                            structureFiltered = structureList
                                .where(
                                  (structureList) =>
                                      structureList.empName
                                          .toLowerCase()
                                          .contains(
                                              _searchResult.toLowerCase()) ||
                                      structureList.empCode
                                          .toLowerCase()
                                          .contains(
                                              _searchResult.toLowerCase()) ||
                                      structureList.designation
                                          .toLowerCase()
                                          .contains(
                                              _searchResult.toLowerCase()) ||
                                      structureList.department
                                          .toLowerCase()
                                          .contains(
                                              _searchResult.toLowerCase()) ||
                                      structureList.basicSalary
                                          .toLowerCase()
                                          .contains(
                                              _searchResult.toLowerCase()) ||
                                      structureList.netSalary
                                          .toLowerCase()
                                          .contains(
                                              _searchResult.toLowerCase()),
                                )
  ...
  callApiToDeleteOrganisation(String id) {
    ...
    _service.deleteSalaryStructure(deleteRequest).then((value) {
