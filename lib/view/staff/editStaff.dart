...
class _EditStaffState extends State<EditStaff> {
  ...
  final EditStaffRequest addCourseRequest = EditStaffRequest(
      "",
      "",
      "",
      "",
  ...
  String editId = '';
  SingleStaffRequest singleStaffRequest = SingleStaffRequest("", "");
  SingleStaffResponse singleStaffResponse = SingleStaffResponse();
  @override
  void initState() {
    super.initState();
    setState(() {
  ...
  void initializeDepartmentData(BuildContext context) {
    ...
    if (arguments['id'] != null) {
      ...
      singleStaffRequest.type = 'view';
      singleStaffRequest.id = editId;
      _service.singleStaff(singleStaffRequest).then((value) {
        singleStaffResponse = value;
        if (singleStaffResponse.category == 'Non-teaching') {
          dropdownvalueService = 'Non-Teaching';
        } else {
          dropdownvalueService = 'Teaching';
        }

        nameController.text = singleStaffResponse.name.toString();
        fatherController.text = singleStaffResponse.fatherName.toString();
        dob.text = singleStaffResponse.dOB.toString();
        desigController.text = singleStaffResponse.designation.toString();
        departController.text = singleStaffResponse.dept.toString();
        panController.text = singleStaffResponse.pancardNo.toString();
        bankController.text = singleStaffResponse.bank.toString();
        accountController.text = singleStaffResponse.bankAccNo.toString();
        ifscController.text = singleStaffResponse.ifsc.toString();
        mobileController.text = singleStaffResponse.contactNo.toString();
        emailController.text = singleStaffResponse.email.toString();
        religionId = singleStaffResponse.religion.toString();
        dropdownvalueService2 = singleStaffResponse.religionName.toString();
        casteController.text = singleStaffResponse.cast.toString();
        bloodController.text = singleStaffResponse.bloodGroup.toString();
        qualifyController.text = singleStaffResponse.qualification.toString();
        addressController.text = singleStaffResponse.address.toString();
        joinController.text = singleStaffResponse.dOJoin.toString();
        retireController.text = singleStaffResponse.dORetire.toString();
        incrementController.text = singleStaffResponse.dOLstIncr.toString();
        promotionController.text = singleStaffResponse.dOLstPromotn.toString();
        phdController.text = singleStaffResponse.dOPhd.toString();
        publicationController.text = singleStaffResponse.dOPub.toString();
        pubtypeController.text = singleStaffResponse.publicationTyp.toString();
        nomineeController.text = singleStaffResponse.nominee.toString();
        relationshipController.text = singleStaffResponse.nomineeRel.toString();
  ...
  Widget build(BuildContext context) {
    ...
    } else if (permissions.contains('edit_staff')) {
      return SafeArea(
        child: Scaffold(
          key: _scaffoldKey,
          appBar: AppBar(
                      ...
                      child: isLoading
                          ...
                          : SingleChildScrollView(
                              child: SizedBox(
                                child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: permissions.contains('edit_staff')
                                        ? Column(
                                            children: [
                                              GridView.count(
                                                physics:
