...
class _ManageStaffState extends State<ManageStaff> {
  ...
  StaffFilterRequest simpleRequest = StaffFilterRequest("", "");
  ...
  void initState() {
    ...
    SharedPreferences.getInstance().then((SharedPreferences sp) {
      ...
      _service.manageStaff(simpleRequest).then((value) {
                    ...
                    child: TextField(
                        ...
                        onChanged: (value) {
                          setState(() {
                            ...
                            structureFiltered = structureList
                                .where((structureList) =>
                                    structureList.name.toLowerCase().contains(
                                        _searchResult.toLowerCase()) ||
                                    structureList.designation
                                        .toLowerCase()
                                        .contains(
                                            _searchResult.toLowerCase()) ||
                                    structureList.joinDate
                                        .toLowerCase()
                                        .contains(
                                            _searchResult.toLowerCase()) ||
                                    structureList.mobile.toLowerCase().contains(
                                        _searchResult.toLowerCase()) ||
                                    structureList.email
                                        .toLowerCase()
