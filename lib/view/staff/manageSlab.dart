...
class ManageSlab extends StatefulWidget {
  const ManageSlab({super.key});

  @override
  State<ManageSlab> createState() => _ManageSlabState();
}

class _ManageSlabState extends State<ManageSlab> {
  int crocesscount = 0;
  ...
  ManageSlabResponse feeStructureResponse = ManageSlabResponse();
  ...
  void initState() {
    ...
    SharedPreferences.getInstance().then((SharedPreferences sp) {
      ...
      _service.manageSlab(simpleRequest).then((value) {
  ...
  Widget build(BuildContext context) {
    ...
    } else if (permissions.contains('manage_slab')) {
      return SafeArea(
        child: Scaffold(
          appBar: AppBar(
            ...
            actions: [
              if (permissions.contains('manage_slab'))
                IconButton(
                  onPressed: (() {
                    Navigator.pushReplacementNamed(context, '/addSlab');
                  }),
                  tooltip: "Add Slab",
                  icon: const Icon(
                        ...
                        onChanged: (value) {
                          setState(() {
                            ...
                            structureFiltered = structureList
                                .where(
                                  (structureList) =>
                                      structureList.slabName
                                          .toLowerCase()
                                          .contains(
                                              _searchResult.toLowerCase()) ||
                                      structureList.slabProperty
                                          .toLowerCase()
                                          .contains(
                                              _searchResult.toLowerCase()) ||
                                      structureList.slabType
                                          .toLowerCase()
                                          .contains(
                                              _searchResult.toLowerCase()),
                                )
                                                                    ...
                                                                    Navigator
                                                                      ...
                                                                      arguments: {
                                                                        'id': structureFiltered[index]
                                                                            .id
                                                                            .toString(),
                                                                        'slabName': structureFiltered[index]
                                                                            .slabName
                                                                            .toString(),
                                                                        'slabProperty': structureFiltered[index]
                                                                            .slabProperty
                                                                            .toString(),
                                                                        'slabType': structureFiltered[index]
                                                                            .slabType
                                                                            .toString(),
                                                                      },
                                                                    );
  ...
  callApiToDeleteOrganisation(String id) {
    ...
    _service.deleteSlab(deleteRequest).then((value) {
