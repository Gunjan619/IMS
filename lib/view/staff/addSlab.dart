...
class AddSlab extends StatefulWidget {
  const AddSlab({super.key});

  @override
  State<AddSlab> createState() => _AddSlabState();
}

class _AddSlabState extends State<AddSlab> {
  int crocesscount = 0;
  ...
  Widget build(BuildContext context) {
    ...
    } else if (permissions.contains('add_slab')) {
      return isLoading
          ? SizedBox(
              width: double.infinity,
              height: double.infinity,
                          ...
                          child: Padding(
                            ...
                            child: SingleChildScrollView(
                              child: SizedBox(
                                child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: permissions.contains('add_slab')
                                        ? Column(
                                            children: [
                                              GridView.count(
