...
class ManageStaffAttend extends StatefulWidget {
  const ManageStaffAttend({super.key});

  @override
  State<ManageStaffAttend> createState() => _ManageStaffAttendState();
}

class _ManageStaffAttendState extends State<ManageStaffAttend> {
  int crocesscount = 0;
  ...
  ManageStaffAttendanceRequest simpleRequest =
      ManageStaffAttendanceRequest("", "", "");
  ManageStaffAttendanceResponse feeStructureResponse =
  ...
  void initState() {
    ...
    SharedPreferences.getInstance().then((SharedPreferences sp) {
      ...
      simpleRequest.fromdate = firstDate.toString();
      simpleRequest.todate = lastDate.toString();

      _service.manageStaffAttendance(simpleRequest).then((value) {
                                                                ...
                                                                child:
                                                                  ...
                                                                  onPressed:
                                                                    ...
                                                                    Navigator
                                                                        .pushNamed(
                                                                      context,
                                                                      '/editBulkStaffAttendance',
                                                                      arguments: {
                                                                        'id': structureFiltered[index]
                                                                            .id
                                                                            .toString(),
                                                                        'category': structureFiltered[index]
                                                                            .empType
                                                                            .toString(),
                                                                        'date': structureFiltered[index]
                                                                            .date
                                                                            .toString(),
                                                                      },
                                                                    );
  ...
  callApiToDeleteOrganisation(String id) {
    ...
    _service.deleteStaff(deleteRequest).then((value) {
